...
function SalaryBenefits() {
  ...
  const fetchPosts = async () => {
    ...
    try {
      ...
      console.error("Error fetching salary & benefits posts:", error);
      setPosts([]);
    } finally {
      setLoading(false);
    }
    ...
    <div className="career-guide">
      ...
      >
        <div className="career-guide__banner-inner">
          <h1 className="career-guide__title">Chế độ lương thưởng</h1>
          <p className="career-guide__subtitle">
            Hiểu rõ về các chế độ lương thưởng và phúc lợi trong công việc
          </p>
        </div>
      </div>
