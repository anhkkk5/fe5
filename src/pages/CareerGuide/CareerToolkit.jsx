...
function CareerToolkit() {
  ...
  const fetchPosts = async () => {
    ...
    try {
      ...
      console.error("Error fetching career toolkit posts:", error);
      setPosts([]);
    } finally {
      setLoading(false);
    }
    ...
    <div className="career-guide">
      ...
      >
        <div className="career-guide__banner-inner">
          <h1 className="career-guide__title">Hành trang nghề nghiệp</h1>
          <p className="career-guide__subtitle">
            Những công cụ và kỹ năng cần thiết để thành công trong sự nghiệp
          </p>
        </div>
      </div>
